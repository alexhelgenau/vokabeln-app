    ...
    <div style={{ minHeight: "100vh", backgroundColor: vintageTheme.bg, display: "flex", justifyContent: "center", alignItems: "center", fontFamily: vintageTheme.serif, padding: "60px 20px" }}>
      ...
      {!isBookOpen ? (
        ...
        <div style={{ position: "relative", width: "100%", maxWidth: "600px" }}>
          ...
          <div style={{ position: "absolute", top: "-175px", right: "-100px", width: "450px", height: "450px", zIndex: 10, pointerEvents: "none", display: "flex", justifyContent: "flex-end", alignItems: "flex-end" }}>
