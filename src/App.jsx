...
export default function App() {
  ...
  const getLevelSass = (level, type) => {
    ...
    const pools = {
      ...
      4: {
        correct: ["Арес бы оценил твой напор, старый кабанчик любит такую дерзость. Точный удар!", "Твой мозг сегодня острый, как мой лучший меч. Ты буквально режешь эти слова пополам.", "Враги бегут in страхе, когда видят твой уровень немецкого! Настоящая лингвистическая атака.", "Точно in цель! Ты попала in смысл слова быстрее, чем стрела пронзает щит слабака.", "Это был настоящий боевой перевод! Ты не просто учишься, ты побеждаешь эти слова.", "Можешь не прикрываться щитом, этот ответ был абсолютно верным. Твоя победа!"],
        wrong: ["Ты сражаешься со словарем как сонная муха со стеклом. Больше агрессии и знаний!", "Промах! Целься in смысл, а не in случайные буквы. Ты же воительница, а не мазила.", "Щит у тебя, может, и есть, а вот ума явно не хватает для такого маневра. Соберись!", "Может, сразу сбросить тебя со скалы, чтобы не мучилась с этими глаголами? Шучу... почти.", "Твоя защита пробита элементарным словом. Какая слабая позиция, доченька!", "Ты ранишь моё божественное сердце своей беспросветной тупостью. Сделай что-нибудь!"]
      },
      5: {
        ...
        wrong: ["Твой оракул сломался, неси новый. Этот ответ — полная противоположность истине.", "У тебя in голове какой-то священный туман, или ты просто забыла всё, что мы учили?", "Это было ложное пророчество. Хватит гадать на кофейной гуще, начни уже учить!", "Будущее твоего уровня XP очень туманно, прямо как этот твой нелепый ответ.", "Пифия снова in запое? Или почему твои ответы не имеют ничего общего с реальностью?", "Всё не так! Твои предсказания сегодня стоят меньше, чем дырявый драхм. Исправляйся!"]
      },
      6: {
        correct: ["Твои знания глубоки, как бездна океана... Ну, по крайней мере, ты не утонула сразу.", "Плывёшь по словарю как дельфин, а не как перепуганная медуза. Впечатляет!", "Ты не утонула in этом слове! Видимо, уроки плавания с Перси не прошли даром.", "Волны успеха омывают твой интеллект. Смотри, не захлебнись от гордости!", "Это морская истина: ты сегодня на удивление сообразительна, доченька.", "Даже Посейдон ставит тебе лайк своим трезубцем. Но до уровня богини тебе ещё грести и грести."],
        wrong: ["Буль-буль! Это была твоя последняя капля здравого смысла. Ошибка!", "Пошла на дно быстрее, чем Титаник. Может, стоит вынырнуть и подумать?", "Я уверен, что даже самый ленивый краб ответил бы лучше. Это позор!", "Захлебнулась in einer единственной букве? Серьёзно? Какое разочарование.", "Морская пена вместо мозгов — это твой новый стиль? Тебе не идёт.", "Твой трезубец явно затупился об твою упёртость. Исправляй это немедленно!"]
      },
      7: {
        correct: ["Прямо in яблочко! Артемида бы взяла тебя на охоту, но только как носильщика стрел.", "Дичь поймана, слово приручено. Твои инстинкты сегодня почти не подводят.", "Хладнокровно и чётко. Ты убиваешь эти тесты так же легко, как я — время на Олимпе.", "Меткий выстрел! Даже без лука ты умудряешься попадать in цель. Чудо какое-то.", "Ни одно немецкое слово не смогло от тебя убежать. Твои сандалии явно быстрее твоих сомнений.", "Артемида одобрительно кивает. Только не вздумай подстрелить моё самолюбие!"],
        wrong: ["Стреляешь in молоко, а метишь in Олимп? Ну-ну, удачи с таким зрением.", "Дичь ушла, а ты осталась стоять с пустыми руками и глупым видом. Снова!", "Твой лук явно не натянут, как и твои извилины. Сосредоточься уже!", "Стреляешь in небо in надежде на чудо? Чуда не будет, будет только работа над ошибками.", "Твои следы ведут in тупик невежества. Попробуй вернуться на тропу разума.", "Промах года! Если бы ты была охотницей, мы бы все давно умерли с голоду."]
      },
      8: {
        correct: ["Твой разум горит ярче, чем олимпийский огонь! Только не сожги мой любимый дневник.", "Уютно, тепло и, на удивление, правильно. Ты сегодня просто золотце.", "Настоящий костер знаний! Гестия in восторге, а я просто in шоке от твоей гениальности.", "Тепло пошло... кажется, твой мозг наконец-то прогрелся до нужной температуры.", "Вижу свет in конце этого длинного слова. Ты справляешься лучше, чем я ожидал.", "Согреваешь мой взор своими правильными ответами. Давай in том же духе, пока не остыла."],
        wrong: ["Твой священный огонь погас. Принеси спички, а лучше — учебник и капельку ума.", "Дымишь, коптишь, но ни капли не греешь. Твой ответ — полная ерунда.", "Холодно! Настолько холодно, что мои крылышки на сандалиях начали замерзать. Ошибка!", "Твой домашний очаг превратился in кучку пепла. Попробуй раздуть угли своего разума.", "От твоего ответа веет таким холодом невежества, что даже на Аляске стало зябко.", "Едва тлеешь, доченька. Если не подкинешь дров (знаний), мы тут все замерзнем."]
      },
      9: {
        correct: ["Почти божественно! Ещё немного, и я начну обращаться к тебе на «Вы». Но не надейся.", "Герои не ошибаются, и ты сегодня это доказываешь. Подозрительно хороший результат.", "Ты уже так близко к вершине, что видишь мои пятки. Не смей останавливаться!", "Твои успехи достойны песен великих муз. Жаль, что у них сегодня выходной.", "Эпический успех! Даже Зевс перестал ворчать, глядя на твои правильные ответы.", "Олимп ждёт тебя! Но помни: я всё равно самый стильный бог in этом пантеоне."],
        wrong: ["Героический провал! Эпично, масштабно и абсолютно неправильно. Браво!", "С небес падать больно, да? Особенно когда летишь вниз головой из-за глупой ошибки.", "Это было совершенно недостойно твоей славы. Соберись, ты же не простая смертная!", "Твой подвиг отменяется, а твоё имя вычеркивается из списка легенд. Попробуй заново.", "Даже Геракл сделал фейспалм, увидев твой перевод. Это было мощно (in плохом смысле).", "Весь Олимп содрогнулся от твоей ошибки. Арес смеется, а мне за тебя стыдно!"]
      }
    };
  ...
  useEffect(() => {
    ...
    if (currentLevel > lastLevel) {
      const up = {
        2: "О? Теперь мы маленькая лесная нимфа, да? Смотри не застрянь in корнях! 🍃",
    ...
    <div style={{ 
      ...
      <style>{`
        ...
        @media (max-height: 800px) {
          .hermes-container { top: -110px; width: 260px; right: -20px; }
          .speech-bubble { width: 170px; margin-right: 70px; font-size: 0.75rem; }
        }
      `}</style>
